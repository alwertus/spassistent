package com.alwertus.spassistent.userold.controller;

import com.alwertus.spassistent.userold.view.AuthenticationRequest;
import com.alwertus.spassistent.user.model.User;
import com.alwertus.spassistent.user.service.UserService;
import com.alwertus.spassistent.userold.view.AuthenticationResponse;
import com.alwertus.spassistent.userold.view.VerifyResponse;
...
//    @Autowired
    ...
    public ResponseEntity<?> createAuthenticateToken(@RequestBody AuthenticationRequest rq) {
        /*try {
            ...
            User user = userService.getUser(rq.getUsername());
